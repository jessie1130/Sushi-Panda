...
if ($result = mysqli_query($link, $sql)) {
    ...
    for ($j = 1; $j <= $total_records; $j++) {
        ...
        $data .= "<div align='right'>
                    ...
                    <input name='user' value='" . $row['account'] . "' style='display: none;'>
                    <input name='date' value='" . $row['board_date'] . "' style='display: none;'>
                    <input name='content' value='" . $row['content'] . "' style='display: none;'>
                    <button class='btn-outline-warning rounded-top btn-sm border' type='summit'>刪除此留言</button>
                </form></div>
                    <div class='card'>
